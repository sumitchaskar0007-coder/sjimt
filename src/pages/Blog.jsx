  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        ...
        if (metaDescription) {
          metaDescription.setAttribute('content', response.data.metaDescription || response.data.excerpt || response.data.content.substring(0, 160));
        }
      } catch (error) {
    ...
    <>
      ...
      <article className="min-h-screen bg-white">
        ...
        <div className="relative">
          ...
          <div className={`max-w-3xl mx-auto px-6 ${blog.featuredImage ? '-mt-20 md:-mt-32' : 'pt-16'}`}>
