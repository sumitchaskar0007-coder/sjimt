...
const BlogAdmin = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData({
      ...formData,
      [name]: type === 'checkbox' ? (checked ? 'published' : 'draft') : value
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.featuredImage instanceof File) {
        dataToSubmit.featuredImage = formData.featuredImage;
      }
      ...
      const errorMessage = error.response?.data?.error || error.message || 'Failed to save blog';
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  rows="3"
                  className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Brief description of the blog (max 160 characters)"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full"
                />
                {editingItem && editingItem.featuredImage && (
                  <div className="mt-2">
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <div 
                          ...
                          dangerouslySetInnerHTML={{ __html: item.excerpt || item.content.substring(0, 150) + '...' }}
                        />
